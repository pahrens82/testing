...
export const ANIMALS = [
    {
        ...
        availability: 1,
        bulk: 0,
        effect: "Provides 1d10+10 meals if slaughtered.",
    },
    {
        name: "Calf",
        cost: 8,
    ...
    },
    {
        ...
        availability: 0,
        bulk: 0,
        effect: "Provides 1 meal if slaughtered.",
    },
    {
        name: "Chicken",
        cost: 0.05,
    ...
    },
    {
        ...
        availability: 1,
        bulk: 0,
        effect: "Provides 1d8+8 meals if slaughtered.",
    },
    {
        name: "Dog, Companion",
        cost: 10,
        availability: 0,
        bulk: 0,
        effect: "A friendly companion to accompany you on your journey. Provides 1d4+4 meals if slaughtered.",
    },
    {
        name: "Dog, Guard",
        cost: 25,
        availability: 1,
        bulk: 0,
        effect: "A dog trained to guard a specific location (Perception 14). Provides 1d4+4 meals if slaughtered.",
    },
    {
        name: "Dog, Hunting",
        cost: 40,
        availability: 1,
        bulk: 0,
        effect: "A dog trained to track prey (Tracking 14). Provides 1d4+4 meals if slaughtered.",
    },
    {
        name: "Dog, War",
        cost: 30,
        availability: 2,
        bulk: 0,
        effect: "A dog trained for combat (Brawling 14). Provides 1d4+4 meals if slaughtered.",
    },
    {
        name: "Donkey",
        cost: 12,
    ...
    },
    {
        ...
        availability: 0,
        bulk: 0,
        effect: "Provides 1d4+4 meals if slaughtered.",
    },
    {
        name: "Goose",
        cost: 0.1,
        availability: 1,
        bulk: 0,
        effect: "Provides 2 meals if slaughtered.",
    },
    {
        name: "Hawk",
        cost: 250,
        availability: 2,
        bulk: 0,
        effect: "A trained hawk that can be used for Hunting. Can only catched small prey (1 meal)."
    },
    {
        name: "Horse, Draft",
        cost: 350,
    ...
    },
    {
        ...
        availability: 0,
        bulk: 0,
        effect: "Provides 1d6+6 meals if slaughtered.",
    },
    {
        name: "Pigeon",
        cost: 0.02,
