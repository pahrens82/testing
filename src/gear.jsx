...
export const ANIMALS = [
    {
        ...
        availability: 1,
        bulk: 0,
        effect: "An uncastrated adult male bovine. Provides 1d10+10 meals if slaughtered.",
    },
    {
        name: "Calf",
        cost: 8,
        availability: 1,
        bulk: 0,
        effect: "Provides 1d6+6 meal if slaughtered.",
    },
    {
        name: "Cat",
        cost: 0.2,
        availability: 0,
        bulk: 0,
        effect: "A small feline companion, often used for pest control.",
    },
    {
        name: "Chicken",
        cost: 0.05,
        availability: 0,
        bulk: 0,
        effect: "Roosters can be used as alarm clocks; hens might lay an egg if you're lucky. Provides 1 meal if slaughtered.",
    },
    {
        name: "Cow",
        cost: 15,
        availability: 1,
        bulk: 0,
        effect: "An adult female bovine. With proper care and nourishment, provides enough milk each day for two meals (or for butter or cheese). Provides 1d8+8 meals if slaughtered.",
    },
    {
        name: "Dog, Companion",
        cost: 10,
        availability: 0,
        bulk: 0,
        effect: "A friendly companion to accompany you on your journey.",
    },
    {
        name: "Dog, Guard",
        cost: 25,
        availability: 1,
        bulk: 0,
        effect: "A dog trained to guard a specific location (Perception 14).",
    },
    {
        name: "Dog, Hunting",
        cost: 40,
        availability: 1,
        bulk: 0,
        effect: "A dog trained to track prey (Tracking 14).",
    },
    {
        name: "Dog, War",
        cost: 30,
        availability: 2,
        bulk: 0,
        effect: "A dog trained for combat (Brawling 14).",
    },
    {
        name: "Donkey",
        cost: 12,
        availability: 1,
        bulk: 0,
        effect: "Useful as a pack animal. Provides 1d8+8 meals if slaughtered.",
    },
    {
        name: "Duck",
        cost: 0.06,
        availability: 0,
        bulk: 0,
        effect: "Quack. Provides 1 meal if slaughtered.",
    },
    {
        name: "Goat",
        cost: 5,
        availability: 0,
        bulk: 0,
        effect: "Will headbutt you. Provides 1d4+4 meals if slaughtered.",
    },
    {
        name: "Goose",
        cost: 0.1,
        availability: 1,
        bulk: 0,
        effect: "A medium-sized bird with an attitude. Provides 2 meals if slaughtered.",
    },
    {
        name: "Hawk",
        cost: 250,
        availability: 2,
        bulk: 0,
        effect: "A trained hawk that can be used for Hunting (Survival 14 only for Hunting). Can only catch small (1 meal) prey."
    },
    {
        name: "Horse, Draft",
        cost: 350,
        availability: 1,
        bulk: 0,
        effect: "A large, powerful horse that is trained for haulting freight and heavy agricultural tasks.",
    },
    {
        name: "Horse, War",
        cost: 700,
        availability: 2,
        bulk: 0,
        effect: "A large, powerful horse that has been trained for combat.",
    },
    {
        name: "Horse, Riding",
        cost: 275,
        availability: 1,
        bulk: 0,
        effect: "A smaller, lithe horse that is accustomed to carrying a rider and a small amount of luggage.",
    },
    {
        name: "Llama",
        cost: 75,
        availability: 1,
        bulk: 0,
        effect: "Can be used for fleece production. Provides 1d8+8 meals if slaughtered.",
    },
    {
        name: "Mule",
        cost: 12,
    ...
    },
    {
        ...
        availability: 1,
        bulk: 0,
        effect: "Oxen are trained for hauling and heavy agricultural tasks. Provides 1d10+10 meals if slaughtered.",
    },
    {
        name: "Partridge",
        cost: 0.1,
        availability: 0,
        bulk: 0,
        effect: "A small, ground-dwelling bird. Provides 1 meal if slaughtered.",
    },
    {
        name: "Pig",
        cost: 6,
        availability: 0,
        bulk: 0,
        effect: "Likes mud, eats almost anything. Provides 1d6+6 meals if slaughtered.",
    },
    {
        name: "Pigeon",
        cost: 0.02,
        availability: 0,
        bulk: 0,
        effect: "A small bird that makes a cooing sound. Provides 1 meal if slaughtered.",
    },
    {
        name: "Sheep",
        cost: 4,
    ...
    },
    {
        ...
        availability: 1,
        bulk: 0,
        effect: "A tall, ground-dwelling, flightless bird. Known to be aggressive. Provides 1d6+6 meals if slaughtered.",
    },
];
