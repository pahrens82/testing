    ...
    return (
        <section className={"container"}>
            ...
            <ul>
                ...
                <li><strong>Find Weak Spot</strong>: If your weapon deals piercing damage, you can try to find a gap in the enemy's worn or natural armor. You get a Bane on the attack, but if it hits, the enemy counts as armorless.</li>
