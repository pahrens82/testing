    ...
    return (
        <section className={"container"}>
            ...
            <ul>
                ...
                <li><strong>Find Weak Spot</strong>: If your melee weapon deals piercing damage, you can try to find a gap in the enemy's worn or natural armor. You get a Bane on the attack, but if it hits, the enemy counts as armorless.</li>
                <li><strong>Topple</strong>: You can try to topple an enemy to the ground instead of inflicting damage. This attack is handled with an opposed roll between your skill level in the weapon you are using and the enemy's Dodge. If your weapon has the toppling feature, you get a Boon. The attack counts as an action for you, but not for your opponent. This acttack cannot be dodged or parried. Monsters cannot be toppled.</li>
            </ul>
        </section>
    );
};
