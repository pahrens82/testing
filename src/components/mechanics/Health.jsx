    ...
    return (
        <section className={"container"}>
            ...
            <section id={"dying"}>
                ...
                <ul>
                    <li><strong>Death Save</strong>: On your turn on each subsequent round, you must make a Death Save -  a roll against your CON. This roll cannot be pushed. After three successful Death Saves you receover 1d6 HP and stop making Death Saves. After three failed Death Saves, your character dies. A critical success counts as two successful rolls, while a critical failure counts as two failed rolls. If combat ends, or if you are dying outside of combat, continue acting in rounds until all Death Saves have been made.</li>
                    ...
                    <li><strong>First Aid</strong>: When a character has 0 HP, another character can use the First Aid action of the Medicine skill. This check gets a Bane if the character making the check doesn't have bandages. If the roll succeeds, the dying character recovers 1d6 HP and doesn't need to make Death Saves anymore. Saving A Life has no effect on characters with HP greater than 0.</li>
                    <li><strong>Rally:</strong>: Another character within 30 feet and earshot can use Persuasion to rally a dying character. If the Persuasion check succeeds, the dying character is able to continue taking their turns as normal, but must keep making Death Saves. You can attempt to Rally yourself, rolling against your WIL with a Bane.</li>
