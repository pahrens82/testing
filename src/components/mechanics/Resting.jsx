        ...
        <section>
            ...
            <ul>
                ...
                <li><strong>Short Rest</strong>: You spend 15 minutes resting, allowing
                    ...
                    <ul>
                        <li>If another character Administers Care to your character you instead regain 2d6 HP.</li>
                    </ul>
                </li>
                <li><strong>Long Rest</strong>: You spend 2 consecutive Shifts resting
                    (a total of 8 hours). If you are in comfortable conditions, you
                    recover all of your lost HP, WP, and Conditions.
                </li>
            </ul>
        </section>
    );
