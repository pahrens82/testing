...
export const Schedule = () => {
    let sessions = [
        new Session({ address: ADDRESSES.me, date: "06/28/2026", host: "TBD" }),
        new Session({ address: ADDRESSES.me, date: "05/XX/2026", host: "Cancelled" }),
        new Session({ address: ADDRESSES.me, date: "04/11/2026", host: "Cancelled" }),
        new Session({ address: ADDRESSES.mike, date: "03/08/2026", host: "Cancelled" }),
        new Session({ address: ADDRESSES.patrick, date: "02/22/2026", host: "Patrick" }),
